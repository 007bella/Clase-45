...
function spawnIngredientes() 
{
      if(World.frameCount % 80 === 0) {
        ingredientes = createSprite(700,400,40,50);
    
    ingredientes.scale = 0.1;
    ingredientes.velocityY = 3;


    ingredientes.x = Math.round(random(10,100));
    ...
    switch(rand) {
      ...
      case 3: ingredientes.addImage(carne);
              break;
      case 4: ingredientes.addImage(jitomate);
              break;
      case 5: ingredientes.addImage(ketchup);
              break;
      case 6: ingredientes.addImage(lechuga);
              break;
